/*! R2Slides v0.1.0
 * https://github.com/SteAllan/R2Slides
 ...
 * Copyright (c) @viljamis
 * Available under the MIT license
 */

(function ($, window, i) {
 	$.fn.r2slides = function (options) {
	    ...
	    var settings = $.extend({
	        ...
	        'pauseButton': false,     // Boolean: Add a button which will pause and play the slider
	        ...
	        'namespace': 'r2slides',  // String: change the default namespace used
		...
		return this.each(function () {
		    ...
		    var $this = $(this),
		        ...
		        // Pager
		        $pager = $('<ul class="' + namespace + '-pager-list ' + namespaceIdx + '-pager-list" />'),

		        // Pause button
		        pauseText = settings.pauseText,
		        playText = settings.playText,
		        $pauser = $('<a class="' + namespace + '-pause-link playing" href="#">' + pauseText + '</a>'),
			...
			if ($slide.size() > 1) {
		        ...
		        if (settings.pager && !settings.manualControls) {
		        	...
		        	$slide.each(function (i) {
		        		var n = i + 1;
		        		tabMarkup +=
		        		'<li class="' + namespace + '-pager-item">' +
		        		'<a href="#" class="' + namespace + '-pager-link ' + slideClassPrefix + n + '">' + n + '</a>' +
		        		'</li>';
		        	});
		        ...
		        if (settings.manualControls) {
		        	...
		        	$pager.addClass(namespace + '-pager-list ' + namespaceIdx + '-pager-list');
		        }
